...
url2 = '&endDate='
url3 = '&targetKey=93&extraIssueFilter=issuetype%20not%20in%20(Schedule%2C%22Meeting%20Minutes%22)'
...
con = sqlite3.connect('C:/Users/telechips/database/tcs.db')
data.to_sql('STB Platform Team', con, if_exists='replace', index = False)
con.close()
