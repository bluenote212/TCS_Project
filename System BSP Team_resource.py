...
url2 = '&endDate='
url3 = '&targetKey=10&extraIssueFilter=issuetype%20not%20in%20(Schedule%2C%22Meeting%20Minutes%22)'
...
data.to_sql('System BSP Team', con, if_exists='replace', index = False)
con.close()
